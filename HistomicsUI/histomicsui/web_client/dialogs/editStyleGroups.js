    ...
    render() {
        ...
        this.$el.html(
            editStyleGroups({
                ...
                //modified
                titleDName:"编辑注释样式", //Edit annotation styles
                nameDName:"名称", //Name
                labelDName:"标签", //Label
                lwDName:"线的宽度", //Line width
                lcDname:'线条颜色', //Line color
                fcDName:"填色", //Fill color
                rtdDName:"重置为默认值", //Reset to Defaults
                sadDName: "另存为默认值", //Save as Defaults
                expoetDName:"导出", //Export
                importDName:"导入",
                cancelDName: "取消", //Cancel
                saveDName:"保存", //save
